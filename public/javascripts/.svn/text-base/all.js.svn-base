...
function initShowHideDivs()
{
    ...
    function scat_mo(t)
	{
	t.className="sub_cat_hover";
	//t.style.backgroundImage="url('http://www.iconspedia.com/images/cat_bg2.jpg')"
	}
	function scat_mout(t)
	{
	t.className="sub_cat";
	//t.style.backgroundImage="url('http://www.iconspedia.com/images/cat_bg1.jpg')"
	}
...
FCKConfig.ToolbarSets["Simple"] = [
	['Bold','Italic','Underline','StrikeThrough','-','OrderedList','UnorderedList','-','Link','Unlink','-','Image','-','Source']
] ;
...
function showOpenIDLoginForm() {
  		Element.hide('normal_login_form');
  		Element.show('openid_login_form');
}

function hideOpenIDLoginForm() {
 		Element.hide('openid_login_form');
  		Element.show('normal_login_form');
}